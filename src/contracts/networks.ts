/**
 * Mina props for all networks that support o1js v1
 * Credit: Mikhail (dfstio) 
 ...
 * Mina and archive endpoints, chain ID, name, account manager, 
 * explorer account URL, explorer transaction URL, and faucet.
 */
